    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div>
                        <center>
                            <img src="{{public_path('img/Logo-Bank-BNI.png')}}" style="width: 250px; height: 100px;" alt="">
                        </center>
                            <p>Silahkan transfer ke rekening di atas</p>
                    </div>
                </div>
                <div>
                        <center>
                            <img src="{{public_path('img/whatsapp-w-number.png')}}" style="width: 150px; height: 50px;" alt="">
                        </center>
                            <p>Silahkan konfirmasi pembayaran dgn mengapload nota ke nomor diatas</p>
            </div>
        </div>
    </div>
</div>
