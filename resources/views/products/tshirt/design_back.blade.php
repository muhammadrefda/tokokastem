...
<head>
    ...
    <title>Desain Kaos Belakang | Toko Kastem</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="shirtDiv" class="page"
                    ...
                    <img id="tshirtFacing" src="{{asset('img/crew_back.png')}}" alt="">
            ...
            <div class="col-md-3">
                ...
                <a href="{{route('tshirt.create.detail.order')}}" class="aa-add-to-cart-btn">
                    Proses Pesanan
                </a>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#imgsavepdf').on('click', function () {
            ...
            setTimeout(function () {
                doc.save("Desain Kaos Belakang.pdf");
                $('.loading-blink').hide();
                $('#test').empty();
            }, 1700);
