        ...
        <div class="row">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            <div class="well">
                                ...
                                <button class="btn btn-primary" onclick="location.reload();" title="Reset Desain">
                                    Reset Desain
                                </button>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div id="shirtDiv" class="page"
                    ...
                    <img id="tshirtFacing" src="{{asset('img/totebag_front.png')}}" alt="">
            ...
            <div class="col-md-3">
                ...
                <a href="{{route('totebag.design.back')}}" class="btn btn-primary">
                    Desain Totebag Belakang
                </a>
            </div>
