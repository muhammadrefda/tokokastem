...
<head>
    ...
    <title>Desain Totebag Belakang | Toko Kastem</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div id="shirtDiv" class="page"
                    ...
                    <img id="tshirtFacing" src="{{asset('img/totebag_back.png')}}" alt="">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#imgsavepdf').on('click', function () {
            ...
            setTimeout(function () {
                doc.save("Desain Totebag Belakang.pdf");
                $('.loading-blink').hide();
                $('#test').empty();
            }, 1700);
