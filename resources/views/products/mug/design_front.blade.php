...
<head>
    ...
    <title>Desain Mug Depan | Toko Kastem</title>
    ...
    <section id="typography">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <a href="{{route('mug.design.back')}}" class="aa-add-to-cart-btn">
                    Proses Pesanan
                </a>
            </div>
